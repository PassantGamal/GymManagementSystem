...
namespace GymManagementBLL.ViewModels
{
    public class UpdateTrainerViewModel {
        ...
        [RegularExpression(@"^(010|011|012|015)\d{8}$", ErrorMessage = "Phone Must Be Valid Egyptian Phone Number")] 
        ...
        public string City { get; set; } = null!; [Required(ErrorMessage = "Specialty Is Required")]
